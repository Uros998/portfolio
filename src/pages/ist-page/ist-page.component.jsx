            ...
            <div className="ist">
                ...
                <div className="ist-container">
                    ...
                    <div className="ist-overview">
                        <h2>OVERVIEW</h2>
                        <p>As scholarship holders at the university, we pay off the university fees by working at the
                            university.
                ...
                <div className="ist-background">
                    ...
                    <div className="ist-background-text">
                        ...
                        <p>
                            ...
                            was the first serious application they had worked on so far. That's the reason we all worked
                            full-stack in order to decide what suits us the best.</p>

                        <h3>My Contribution</h3>
                        <p>This was my first serious application that I worked on with two other students. We worked
                ...
                <div className="ist-container">
                    <div className="ist-problems">
                        ...
                        <p>The problem we had was that we kept records in excel and had to enter and calculate
                            everything manually. Errors often occurred and it was difficult to keep up with them. We
                            also didn't always have insight into how much we had left to pay and how much we earned.
                        </p>
                    </div>
                </div>
